...
## Report bugs using Github's [issue tracker](https://github.com/yourusername/order-payment-microservices/issues)
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/yourusername/order-payment-microservices/issues/new); it's that easy!
...
* Run `mvn clean format` to format Java code
